...
//! Так вот седьмой пункт ДЗ - сделал массив элементов через цикл
let totalInputEls = []
for (const iterator of document.getElementsByClassName('total-input')) {
    totalInputEls.push(iterator)
}

//! Тут до сих пор не понятно что надо сделать, просто создать переменную
//! и загнать в нее коллекцию по классу screen?
